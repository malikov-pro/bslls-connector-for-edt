...
import com.github.malikovpro.dt.bsl.lsconnector.util.VersionCompare;
...
public class LsStatusService {
    ...
    private static final String CONNECTOR_UPSTREAM_API = "https://api.github.com/repos/malikov-pro/bslls-connector-for-edt/releases?per_page=5";
