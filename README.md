...
4. Если BSL LS не успевает стартовать на крупной конфигурации, увеличьте **«Таймаут initialize, с»** (умолчание 15, диапазон 5–3600). Признак нехватки: в журнале «BSL LS не ответил на initialize за 15 с».
